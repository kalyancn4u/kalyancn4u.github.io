---
layout: post
title: "🌈 Learning faster & better!"
description: "A novice-friendly Guide to Learning Anything Better & Faster!"
...
6. Roediger, H. L., & Butler, A. C. (2011). "The critical role of retrieval practice in long-term retention." *Trends in Cognitive Sciences*.
7. Karpicke, J. D., & Roediger, H. L. (2008). "The critical importance of retrieval for learning." *Science*.
8. Dunlosky, J., et al. (2013). "Improving students' learning with effective learning techniques." *Psychological Science in the Public Interest*.
9. MIT Open Learning - Research-based learning findings on retrieval practice
10. University of California, San Diego - Psychology Department materials on retrieval practice

### Interleaving Practice
11. Rohrer, D., & Taylor, K. (2007). "The shuffling of mathematics problems improves learning." *Instructional Science*.
12. Carpenter, S. K., et al. (2012). "Using spacing to enhance diverse forms of learning." *Educational Psychology Review*.

### Sleep and Memory Consolidation
13. Walker, M. P., & Stickgold, R. (2006). "Sleep, memory, and plasticity." *Annual Review of Psychology*.
14. Yale School of Medicine (2022). "Sleep's Crucial Role in Preserving Memory."
15. Harvard Medical School - Sleep Medicine Division (2008). "Sleep and Memory."
16. Diekelmann, S., & Born, J. (2010). "The memory function of sleep." *Nature Reviews Neuroscience*.
17. National Library of Medicine/NCBI (2023). "Sleep—A brain-state serving systems memory consolidation." *Neuron*.
18. Sleep Foundation (2024). "How Memory and Sleep Are Connected."

### Exercise and Brain Function
19. Erickson, K. I., et al. (2011). "Exercise training increases size of hippocampus and improves memory." *Proceedings of the National Academy of Sciences*.
20. Van Praag, H., et al. (1999). "Running enhances neurogenesis, learning, and long-term potentiation in mice." *Proceedings of the National Academy of Sciences*.
21. Gomez-Pinilla, F., & Hillman, C. (2013). "The influence of exercise on cognitive abilities." *Comprehensive Physiology*.
22. El Hayek, L., et al. (2019). "Lactate mediates the effects of exercise on learning and memory through SIRT1-dependent activation of hippocampal BDNF." *Journal of Neuroscience*.
23. Nature Scientific Reports (2019). "Long-term exercise training improves memory in middle-aged men and modulates peripheral levels of BDNF."
24. Frontiers in Neuroscience (2018). "Exercise-Mediated Neurogenesis in the Hippocampus via BDNF."
25. American University (2024). "How Exactly Does Exercise Affect Our Brain Function?"

### Cognitive Science & Learning Strategies
26. Brown, P. C., Roediger, H. L., & McDaniel, M. A. (2014). *Make It Stick: The Science of Successful Learning*. Harvard University Press.
27. Learning Scientists (learningscientists.org) - Evidence-based learning strategies
28. BrainFacts.org (2021). "The Neuroscience Behind the Spacing Effect."

### General Memory and Learning
29. Bjork, R. A., & Bjork, E. L. (1992). "A new theory of disuse and an old theory of stimulus fluctuation." *From Learning Processes to Cognitive Processes: Essays in Honor of William K. Estes*.
30. National Institutes of Health (NIH) - Multiple publications on memory and learning
